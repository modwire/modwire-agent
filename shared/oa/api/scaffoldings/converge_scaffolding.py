...
from ...models.scaffolding_convergence_in import ScaffoldingConvergenceIn
...
def _get_kwargs(
    *,
    body: ScaffoldingConvergenceIn,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/scaffoldings/converge",
    }
...
def sync_detailed(
    *,
    ...
    """Validate or transactionally reconcile a complete scaffolding aggregate.

...
from modwire.apps.records.importing import import_scraped_records
from modwire.apps.scrapers.spiders.registry import get_source, list_sources
...
class Command(BaseCommand):
    ...
    def run_spider(
        ...
        *,
        ...
        items: list = []
        settings = Settings()
        settings.setmodule("modwire.apps.scrapers.settings")
